...
get_weather_forecaset_by_cities <- function(city_names){
  ...
  for (city_name in city_names){
    ...
    api_key <- "8e9f83353198340479e43d48cef10a2f"
...
predict_bike_demand <- function(TEMPERATURE, HUMIDITY, WIND_SPEED, VISIBILITY, SEASONS, HOURS){
  model <- load_saved_model("https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBMDeveloperSkillsNetwork-RP0321EN-SkillsNetwork/labs/module_5/bike_weather_app/model.csv")
...
generate_city_weather_bike_data <- function (){
  cities_df <- read_csv("https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBMDeveloperSkillsNetwork-RP0321EN-SkillsNetwork/labs/module_5/bike_weather_app/selected_cities.csv")
